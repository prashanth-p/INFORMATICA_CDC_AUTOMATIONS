...
# Purpose: This Script will update the Planned activity flag in CDL Publisher Prod Config
# -----------------------------------------------------------------------------------------
# Version: 1.0.0
# -----------------------------------------------------------------------------------------
...
main() {
    ...
    MODULE_HEADER
    echo -e "You have selected: Enable/disable Planned Activity - PowerExchange Prod"
    echo
...
PLANNED_ACTIVITY_FLAG() {
    ...
    $ALERT_EMAILS_PLANNED_ACTIVITY_PWX_PROD_SCRIPT_API "$pwx_instance" "$updateFlag" "$user_email_id" "$change" "$comments" "$changeStartTime" "$changeEndTime"
...
MODULE_HEADER() {
    ...
    echo
    echo "#######################################################################"
    echo "Module : PowerExchange Prod: enable_disable_planned_activity.sh"
    echo "#######################################################################"
    echo
}
