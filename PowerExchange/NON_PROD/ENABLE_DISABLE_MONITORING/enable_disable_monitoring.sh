...
# Purpose: This Script will update the kafka activity flag in CDL Publisher NON_PROD Config
# -----------------------------------------------------------------------------------------
# Version: 1.0.0
# -----------------------------------------------------------------------------------------
...
main() {
    ...
    MODULE_HEADER
    echo -e "You have selected: Permanent Enable/disable Monitoring - PowerExchange NON_PROD"
    echo
...
MONITORING_FLAG() {
    ...
    $ALERT_EMAILS_MONITORING_PWX_NON_PROD_SCRIPT_API "$pwx_instance" "$updateFlag" "$user_email_id" "$change" "$comments"
...
MODULE_HEADER() {
    ...
    echo
    echo "#############################################################"
    echo "Module : PowerExchange NON_PROD: enable_disable_monitoring.sh"
    echo "#############################################################"
    echo
}
